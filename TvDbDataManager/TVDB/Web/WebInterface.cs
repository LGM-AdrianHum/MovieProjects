...
namespace TVDB.Web
{
    ...
    public class WebInterface : ITvDb
    {
        ...
        public async Task<List<Mirror>> GetMirrors()
        {
            ...
            try
            {
                result = await _client.DownloadDataTaskAsync(string.Format(url, _apiKey)).ConfigureAwait(continueOnCapturedContext: false);
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<Language>> GetLanguages()
        {
            ...
            return await GetLanguages(_defaultMirror).ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        public async Task<List<Language>> GetLanguages(Mirror mirror)
        {
            ...
            var result = await _client.DownloadDataTaskAsync(string.Format(url, mirror.Address, _apiKey)).ConfigureAwait(continueOnCapturedContext: false);
            var resultStream = new MemoryStream(result);
        ...
        public async Task<List<Series>> GetSeriesByName(string name, Mirror mirror)
        {
            ...
            return await GetSeriesByName(name, "en", mirror).ConfigureAwait(continueOnCapturedContext: false);
        }
        ...
        public async Task<List<Series>> GetSeriesByName(string name, string languageAbbreviation, Mirror mirror)
        {
            ...
            var result = await _client.DownloadDataTaskAsync(
                $"{mirror.Address}/api/GetSeries.php?seriesname={name}&language={languageAbbreviation}").ConfigureAwait(continueOnCapturedContext: false);
            var resultStream = new MemoryStream(result);
        ...
        public async Task<List<Series>> GetSeriesByRemoteId(string imdbId, string zap2Id, Mirror mirror)
        {
            ...
            var result = await GetSeriesByRemoteId(imdbId, zap2Id, "en", mirror).ConfigureAwait(continueOnCapturedContext: false);
            return result;
        }
        ...
        public async Task<List<Series>> GetSeriesByRemoteId(string imdbId, string zap2Id, string languageAbbreviation, Mirror mirror)
        {
            ...
            var result = await _client.DownloadDataTaskAsync(string.Format(url, mirror.Address, imdbId, languageAbbreviation, zap2Id)).ConfigureAwait(continueOnCapturedContext: false);
            var resultStream = new MemoryStream(result);
        ...
        public async Task<SeriesDetails> GetFullSeriesById(int id, Mirror mirror)
        {
            ...
            var result = await GetFullSeriesById(id, "en", mirror).ConfigureAwait(continueOnCapturedContext: false);
            return result;
        }
        ...
        public async Task<SeriesDetails> GetFullSeriesById(int id, string languageAbbreviation, Mirror mirror)
        {
            ...
            var result = await _client.DownloadDataTaskAsync(
                $"{mirror.Address}/api/{_apiKey}/series/{id}/all/{languageAbbreviation}.zip").ConfigureAwait(continueOnCapturedContext: false);
