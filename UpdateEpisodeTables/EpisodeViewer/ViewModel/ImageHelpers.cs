...
namespace EpisodeViewer.ViewModel
{
    public static class ImageHelpers
    {
        ...
        public static bool IsMovie(this string data)
        {
            ...
            if (((IList) allvideotype).Contains(data.ToLower())) return true; // extension only handler.
            var ext = Path.GetExtension(data);
            return ((IList) allvideotype).Contains(ext.ToLower());
        }
        public static ImageSource CreateImageSource(string file, bool forcePreLoad = true)
        {
